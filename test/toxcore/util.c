...
char const *
type_name (msgpack_object_type type)
{
  switch (type)
    {
...
int
msgpack_pack_string (msgpack_packer *pk, char const *str)
{
...
int
msgpack_pack_vstringf (msgpack_packer *pk, char const *fmt, va_list ap)
{
  char buf[1024];
...
int
msgpack_pack_stringf (msgpack_packer *pk, char const *fmt, ...)
{
  va_list ap;
  va_start (ap, fmt);
